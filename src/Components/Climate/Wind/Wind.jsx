...
function Climate() {
  return (
     ...
     <div className="inline-flex flex-col space-y-32  pl-14 pr-56 pt-7 left-0 top-0"  >
        <p className=" flex justify-center text-7xl font-extrabold leading-10 text-gray-800">Weather & Climate</p>
